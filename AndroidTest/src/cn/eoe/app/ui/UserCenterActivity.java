...
import cn.eoe.app.fragment.E0_ProfileFragment;
...
public class UserCenterActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		E0_ProfileFragment profileFragment = new E0_ProfileFragment();
    	FragmentTransaction localFragmentTransaction = getSupportFragmentManager().beginTransaction();
    	localFragmentTransaction.replace(R.id.fragment_container, profileFragment, "account_info_frag");
