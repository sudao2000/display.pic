...
import cn.eoe.app.fragment.UserCollectFragment;
import cn.eoe.app.fragment.UserIntroFragment;
import cn.eoe.app.fragment.UserLogOutFragment;
...
public class UserLoginEoeHttpActivity extends BaseFragmentActivity implements
		OnClickListener {
	...
	public class TabPageAdapter extends FragmentPagerAdapter {
		...
		public TabPageAdapter(UserLoginEoeHttpActivity userCenterActivity) {
		...
		public void onClick(View v) {
			...
			case R.id.imageview_user_title:
				new PopupWindowUtil(mViewPager).showActionWindow(v,
						UserLoginEoeHttpActivity.this, mTabsAdapter.tabs);
				break;
			}
		}
	}
