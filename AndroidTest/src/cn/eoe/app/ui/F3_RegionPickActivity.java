...
import cn.eoe.app.model.ADDRESS;
...
public class F3_RegionPickActivity extends Activity implements
		cn.eoe.app.model.BusinessResponse {
	
	public static final int REGION_LIST_OK = 0;
	public static final int REGION_LIST_FAILED = 1;
//
...
//				}
//				addressModel.region(Integer.parseInt(addressModel.regionsList0
//						.get(position).id));
//
//			}
//		});
...
//		}
//
//		spinnerAdapter = new F3_RegionPickAdapter(this,
//				addressModel.regionsList0);
