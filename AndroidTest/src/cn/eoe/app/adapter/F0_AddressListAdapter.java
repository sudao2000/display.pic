...
//import cn.eoe.app.ui.F2_EditAddressActivity;
...
public class F0_AddressListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (address.province_name != null && !address.province_name.equals("null"))
			holder.province.setText(address.province_name);
		if(address.city_name != null && !address.city_name.equals("null")) {
			holder.city.setText(address.city_name);
		}
		if(address.district_name != null && !address.district_name.equals("null")) {
